...
void init()
{
	...
	// 设置物体的旋转位移
	table->setTranslation(glm::vec3(-0.2, -0.2, 0.2));
	table->setRotation(glm::vec3(-90.0, 0.0, 0.0));
	table->setScale(glm::vec3(0.75, 0.75, 0.75));
	...
	// 设置物体的旋转位移
	wawa->setTranslation(glm::vec3(0.2, 0.0, -0.2));
	wawa->setRotation(glm::vec3(-90.0, -20.0, 0.0));
